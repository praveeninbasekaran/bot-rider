...
Status: **F8a shipped. F8b shipped. F8c planned.** FO-1–FO-4 have no runtime or chrome implementation; §502 records the accepted target design. F8a/WK and F8b/AG remain shipped and must not be reopened except through a superseding requirement.
