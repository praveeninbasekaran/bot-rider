...
**Out:** F8b Argue chrome · F8c idle follow-on · F8d Stop-one / compare-to-spec · N Approves · combined Files+MCP Approve · reserved Dev1/Dev2/tester chrome · per-Send picker · Save-time designation gate · new sidebar · new Activity Bar icon · Event Bus chrome · reopening §20–§26.
