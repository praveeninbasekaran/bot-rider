...
**Out:** F8c idle follow-on · F8d Stop-one / compare-to-spec · N Approves · combined Files+MCP Approve · reserved Dev1/Dev2/tester chrome · per-Send picker · Save-time designation gate · new sidebar · new Activity Bar icon · Event Bus chrome · reopening §20–§26. **F8b Argue chrome** is this addendum (§28), not out of the product forever.
